        ...
        {portals.map((portal, i) => (
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-sm text-white/45 leading-relaxed">{portal.description}</p>
            </div>
              ...
              {portal.active ? (
                <>
                  <div className="flex items-center gap-1.5">
                    ...
                    {portal.external && (
                      <span className="text-[10px] font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full bg-violet-500/20 border border-violet-400/30 text-violet-300">
                        Portal 5
                      </span>
                    )}
                  </div>
